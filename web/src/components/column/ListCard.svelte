    ...
    <div class="flex justify-between group mt-2 text-sm -mb-1 opacity-75">
      <div class="flex items-center space-x-1.5">
        ...
        {#if card.checklist.length}
          <div class={checklistCompleted == card.checklist.length ? "flex items-center rounded text-white bg-green-500 py-1" : "flex items-center rounded py-1"}>
        ...
        {/if}
        {#if card.due}
          <div class={card.isComplete ? "flex items-center rounded text-white bg-green-500 py-1" : card.due < new Date().getTime() ? "flex items-center rounded text-white bg-orange-600 py-1" : "flex items-center rounded py-1"}>
